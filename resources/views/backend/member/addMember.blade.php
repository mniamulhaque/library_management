  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Member {{ isset($memberData) ? 'Update ' : 'Register ' }} Form</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">{{ isset($memberData) ? 'Update ' : 'Add ' }} Member Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <!-- form start -->
               <form action="{{ isset($memberData) ? route('members.update', $memberData->id) : route('members.store') }}" method="POST">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">{{ isset($memberData) ? 'Update ' : 'Submit ' }}</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
