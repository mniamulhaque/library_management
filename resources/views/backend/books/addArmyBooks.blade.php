  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Army Publication Book {{ isset($books) ? 'Update' : 'Register' }} Form</h1>
          </div>
          <div class="col-sm-6">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12 col-sm-12">
                          <select class="form-control" style="width: 100%;" name="book_cat" required hidden>
                            <option value="{{ isset($books) ? $books->book_cat : 'Army Publication' }}">{{ isset($books) ? $books->book_cat : 'Army Publication' }}</option>
                          </select>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{ isset($books) ? $books->types : '' }}" class="form-control" name="types" id="types" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                      <label for="example1">Corps</label>
                       <input type="text" value="{{ isset($books) ? $books->corps : '' }}" class="form-control" id="corps" name="corps" required>
                    </div>
                    </div>
                  </div>
                  <div class="row">
