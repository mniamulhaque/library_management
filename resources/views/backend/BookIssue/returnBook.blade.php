                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                       <div class="form-group">
                          <label>Army No</label>
                          <select class="form-control select2" style="width: 100%;" name="member_id" id="member_id">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="corps" name="corps" placeholder="Enter Corps">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="year_of_publication">Unite/Organization</label>
                        <input type="Text" class="form-control" id="unite" name="unite" placeholder="Enter Unite/Organization">
                      </div>
                    </div>
                  </div>
                   <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="author">Book Name</label>
                         <select class="form-control select2" style="width: 100%;" id="book_name" name="book_name">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="return_date" name="return_date" placeholder="Enter Mobile No">
                      </div>
                    </div>
                  </div>
